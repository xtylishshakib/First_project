...
from app.models import Staff,Staff_Notification,Staff_leave,Staff_Feedback,Subject,Session_Year,Student,Attendance,Attendance_Report,Subject,StudentResult
from pyexpat.errors import messages
from django.contrib import messages
from django.contrib.auth.decorators import login_required
import json

#from student_management_system.app.models import Subject, Session_Year
#from app.models import Student

#from student_management_system.app.models import Student
...
def STAFF_SAVE_RESULT(request):
    if request.method == "POST":
        ...
        if check_exists:
            ...
            result.save()
            messages.success(request,'Result Are Sucessfully Updated !')
            ...
            result.save()
            messages.success(request, 'Result Are Sucessfully Added !')
            return redirect('staff_add_result')
    return None